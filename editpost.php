...
<body>
    <form name="editForm" action="seditpost.php" method="post">
    <?php
    ...
    if(isset($_SESSION['UserID'])){ // ตรวจสอบว่ามีผู้ใช้ล็อกอินอยู่หรือไม่
        ...
        $sql = "SELECT * FROM discussion WHERE postID='$postID'";
        ...
        ?>
            <div class="container">
                <div class="alert alert-success">
                    <h2 style="color:Tomato;">แก้ไขโพสต์</h2>
                </div>
                <table class="table table-hover table-bordered">
                    <tr>
                        <th width="150">ลำดับโพสต์</th>
                        <td width="240">
                            <input type="hidden" name="postID" value="<?php echo $result["postID"]; ?>">
                            <?php echo $result["postID"]; ?>
                        </td>
                    </tr>
                    <tr>
                        <th width="150">ชื่อผู้โพสต์</th>
                        <td width="240">
                    ...
                    <tr>
                        <th width="150">เนื้อหา</th>
                        <td width="240"><input type="text" class="form-control" name="post" value="<?php echo $result["post"]; ?>"></td>
                    </tr>
                    <tr>
                        <th width="150">วันที่โพสต์</th>
                        <td width="240">
