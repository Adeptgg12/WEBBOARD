...
<body class="align">
  <div class="grid">
    ...
    <p class="text--center">Already a member? <a href="index.php">Sign in now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
  </div>
