...
<body class="align">
  <div class="grid">
    ...
    <form action="register.php" method="POST" class="form login">
      <?php
        echo "<center><font color='red'>Usernameนี้มีคนใช้งานไปแล้วไอ่สัส</font></center>"
      ?>
      <div class="form__field">
        ...
        <input id="Name" type="text" name="txtName" class="form__input" placeholder="Name" required>
      </div>
      <div class="form__field">
    ...
    <p class="text--center">Already a member? <a href="index.html">Sign in now</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
  </div>
