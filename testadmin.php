        ...
        <div class="row">
            <div class="col col-sm-12">
                <nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary">
                    <a class="navbar-brand" href="testadmin.php"><img src="img/logo.png" alt="#" width="110" height="40"></a>
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-striped">
                    ...
                    <?php
                    $sql = "SELECT * FROM discussion ORDER BY postID desc"; // Change to your table name
